...
public class HashBase {
    ...
    static final String db = "ildarglasses";
    static final String driver = "com.mysql.jdbc.Driver";
    static final String user = "root";
    static final String pass = "bl3000";
    ...
    private static String replacement(File file) {
        ...
        String imageExt = filePath.substring(filePath.lastIndexOf('.'));  // get image's extension
    ...
    public static void addValues(int[] hashCode, File file, String description) {
        ...
        sb.append(quote);
        sb.append(replacement(file));    //replace to ..\inImageBase\ and gets new image's path
        sb.append(quote);
        sb.append(')');
    ...
    public static List<String> startSearch(int max) {
        ...
        try {
            ...
            int distance;
            while (rs.next()) {
                distance = ImageWork.checkingHemingDistance(rs.getInt(1), rs.getInt(2), rs.getInt(3), max);
                if (distance != -1) {
    ...
    public static void correctBase() {
        ...
        try {
            ...
            st = con.createStatement(); //statement for deleting unexisting image's path
            String temp;
            while (rs.next()) {
                temp = rs.getString(2);
